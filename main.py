...
def claude_curate(
    ...
    prompt = (
        ...
        "write 'summary' (ONE short factual sentence, max ~18 words, strictly grounded in the "
        "supplied metadata; no hype, no invented facts) and 'why' (one short sentence on why it "
